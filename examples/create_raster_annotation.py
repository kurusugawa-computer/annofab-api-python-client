...
def create_annotation_with_image(project_id: str, task_id: str, input_data_id: str, image_file_list: List[Any], account_id: str, details: Optional[List[Annotation]] = None):
