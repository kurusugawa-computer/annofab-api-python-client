...
class Wrapper:
    ...
    #########################################
    def copy_annotation_specs(self, src_project_id: str, dest_project_id: str) -> Dict[str, Any]:
        """
    ...
    def upload_file_to_s3(self, project_id: str,
                          file_path: str,
    ...
    def put_input_data_from_file(self, project_id: str,
                                 input_data_id: str,
                                 file_path: str,
    ...
    #########################################
    def put_supplementary_data_from_file(self, project_id,
                                         input_data_id: str,
    ...
    def put_project_members(self, project_id, project_members: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
    ...
    def assign_role_to_project_members(self, project_id: str,
                                       ...
                                       member_role: str) -> List[Dict[str, Any]]:
        """
    ...
    def drop_role_to_project_members(self, project_id,
                                     user_id_list: List[str]) -> List[Dict[str, Any]]:
        """
    ...
    def copy_project_members(self, src_project_id: str,
                             dest_project_id: str,
                             delete_dest: bool = False) -> List[Dict[str, Any]]:
        """
    ...
    #########################################
    def delete_all_succeeded_job(self, project_id: str, job_type: str) -> List[Dict[str, Any]]:
        """
        成功したジョブをすべて削除する
        Args:
            project_id: プロジェクトID
