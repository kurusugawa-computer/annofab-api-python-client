...
class TaskAssignRequestTypeTaskProperty(BaseModel):
    """
    TaskAssignRequestTypeTaskProperty
    """

    phase: TaskPhase
    type: Optional[StrictStr] = Field(default=None, description="`TaskProperty` ", alias="_type")
    __properties: ClassVar[List[str]] = ["phase", "_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"phase": obj.get("phase"), "_type": obj.get("_type")})
        return _obj
