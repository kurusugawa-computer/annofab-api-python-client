...
class OrganizationPluginCompatibilityTypeBottom(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(
        default=None,
        description="inputに指定した場合、いずれのプラグインも前段になれないことを示します。 outputに指定した場合、いずれのプラグインも後段になれないことを示します。 ",
        alias="_type",
    )
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(["Bottom"]):
            raise ValueError("must be one of enum values ('Bottom')")
        return value
