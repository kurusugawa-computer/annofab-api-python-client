...
class Resolution(BaseModel):
    ...
    width: StrictInt = Field(description="画像の幅[ピクセル]")
    height: StrictInt = Field(description="画像の高さ[ピクセル]")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"width": obj.get("width"), "height": obj.get("height")})
        return _obj
