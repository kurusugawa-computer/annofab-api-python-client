...
class BatchAnnotationRequestItemPutV2(BaseModel):
    """
    アノテーション更新
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(["PutV2"]):
            raise ValueError("must be one of enum values ('PutV2')")
        return value
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"data": BatchAnnotationV2.from_dict(obj["data"]) if obj.get("data") is not None else None, "_type": obj.get("_type")}
        )
        return _obj
