...
class FullAnnotationAdditionalDataValueInteger(BaseModel):
    """
    FullAnnotationAdditionalDataValueInteger
    """

    type: StrictStr = Field(description="`Integer` ", alias="_type")
    value: Optional[StrictInt] = Field(default=None, description="整数値")
