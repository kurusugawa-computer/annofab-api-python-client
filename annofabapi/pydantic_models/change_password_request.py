...
class ChangePasswordRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["user_id", "old_password", "new_password"]
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"user_id": obj.get("user_id"), "old_password": obj.get("old_password"), "new_password": obj.get("new_password")})
        return _obj
