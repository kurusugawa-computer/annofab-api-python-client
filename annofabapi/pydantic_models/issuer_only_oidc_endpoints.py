...
class IssuerOnlyOidcEndpoints(BaseModel):
    """
    OIDCエンドポイント
    """
    ...
    __properties: ClassVar[List[str]] = ["_type", "issuer"]

    @field_validator("type")
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["IssuerOnly"]):
            raise ValueError("must be one of enum values ('IssuerOnly')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"_type": obj.get("_type"), "issuer": obj.get("issuer")})
        return _obj
