...
class AnnotationTypeFieldValueOneIntegerFieldValue(BaseModel):
    """
    数値をひとつだけ持つフィールド
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["OneIntegerFieldValue"]):
            raise ValueError("must be one of enum values ('OneIntegerFieldValue')")
        return value
