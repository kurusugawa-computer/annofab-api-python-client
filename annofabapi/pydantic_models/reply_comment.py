...
class ReplyComment(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="`Reply` [詳しくはこちら](#section/API-Convention/API-_type) ", alias="_type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"root_comment_id": obj.get("root_comment_id"), "_type": obj.get("_type")})
        return _obj
