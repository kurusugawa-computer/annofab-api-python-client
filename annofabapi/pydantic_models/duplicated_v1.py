...
class DuplicatedV1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["label_id", "annotation_id", "additional_data", "_type"]

    @field_validator("type")
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["Duplicated"]):
            raise ValueError("must be one of enum values ('Duplicated')")
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "additional_data": AdditionalDataV1.from_dict(obj["additional_data"]) if obj.get("additional_data") is not None else None,
                "_type": obj.get("_type"),
            }
        )
        return _obj
