...
class OrganizationRegistrationRequest(BaseModel):
    ...
    organization_email: StrictStr = Field(description="メールアドレス")
    __properties: ClassVar[List[str]] = ["organization_name", "organization_email"]
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"organization_name": obj.get("organization_name"), "organization_email": obj.get("organization_email")})
        return _obj
