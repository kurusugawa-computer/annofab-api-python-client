...
class AnnotationSpecsV3(BaseModel):
    """
    AnnotationSpecsV3
    """
    ...
    annotation_type_version: StrictStr | None = Field(
        default=None,
        description="アノテーション種別のバージョン。  拡張仕様プラグインで定義した値が転写されます。プロジェクトに拡張仕様プラグインが設定されていない場合は未指定です。 ",
    )
