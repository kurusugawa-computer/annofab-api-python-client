...
class AnnotationTypeFieldValueMarginOfErrorTolerance(BaseModel):
    """
    誤差許容範囲
    """
    ...
    __properties: ClassVar[List[str]] = ["_type", "max_pixel"]

    @field_validator("type")
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["MarginOfErrorTolerance"]):
            raise ValueError("must be one of enum values ('MarginOfErrorTolerance')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"_type": obj.get("_type"), "max_pixel": obj.get("max_pixel")})
        return _obj
