...
class PutOrganizationRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"organization_name": obj.get("organization_name"), "last_updated_datetime": obj.get("last_updated_datetime")})
        return _obj
