...
class InspectionPhrase(BaseModel):
    """
    InspectionPhrase
    """

    id: StrictStr = Field(description="定型指摘ID")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"id": obj.get("id"), "text": InternationalizationMessage.from_dict(obj["text"]) if obj.get("text") is not None else None}
        )
        return _obj
