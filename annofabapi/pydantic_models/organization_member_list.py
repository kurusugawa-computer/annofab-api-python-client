...
from annofabapi.pydantic_models.organization_member import OrganizationMember
...
class OrganizationMemberList(BaseModel):
    ...
    list: List[OrganizationMember] = Field(description="組織メンバーの一覧")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "list": [OrganizationMember.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None,
