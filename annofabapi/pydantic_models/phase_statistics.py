...
class PhaseStatistics(BaseModel):
    ...
    phase: TaskPhase
    worktime: StrictStr = Field(description="累積作業時間（ISO 8601 duration）")
    __properties: ClassVar[List[str]] = ["phase", "worktime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"phase": obj.get("phase"), "worktime": obj.get("worktime")})
        return _obj
