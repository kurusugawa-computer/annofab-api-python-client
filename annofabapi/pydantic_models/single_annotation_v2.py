...
from annofabapi.pydantic_models.single_annotation_detail_v2 import SingleAnnotationDetailV2


class SingleAnnotationV2(BaseModel):
    """
    SingleAnnotationV2
    """
        ...
        _obj = cls.model_validate(
            {
                ...
                "detail": SingleAnnotationDetailV2.from_dict(obj["detail"]) if obj.get("detail") is not None else None,
