...
class ProjectCopyResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["job", "dest_project"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of dest_project
        if self.dest_project:
            _dict["dest_project"] = self.dest_project.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "job": ProjectJobInfo.from_dict(obj["job"]) if obj.get("job") is not None else None,
                "dest_project": Project.from_dict(obj["dest_project"]) if obj.get("dest_project") is not None else None,
            }
        )
        return _obj
