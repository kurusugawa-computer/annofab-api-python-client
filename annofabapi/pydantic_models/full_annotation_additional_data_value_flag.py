...
class FullAnnotationAdditionalDataValueFlag(BaseModel):
    """
    FullAnnotationAdditionalDataValueFlag
    """

    type: StrictStr = Field(description="`Flag` ", alias="_type")
    value: StrictBool = Field(description="フラグのON(true)またはOFF(false)")
