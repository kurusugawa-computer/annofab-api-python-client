...
class FullAnnotationDataSinglePoint(BaseModel):
    """
    FullAnnotationDataSinglePoint
    """

    point: Point
    type: StrictStr = Field(description="`SinglePoint` ", alias="_type")
    __properties: ClassVar[List[str]] = ["point", "_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"point": Point.from_dict(obj["point"]) if obj.get("point") is not None else None, "_type": obj.get("_type")})
        return _obj
