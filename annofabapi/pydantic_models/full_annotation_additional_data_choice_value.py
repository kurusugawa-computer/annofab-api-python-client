...
class FullAnnotationAdditionalDataChoiceValue(BaseModel):
    """
    FullAnnotationAdditionalDataChoiceValue
    """

    id: StrictStr = Field(description="選択肢ID。[値の制約についてはこちら。](#section/API-Convention/APIID) ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"id": obj.get("id"), "name": InternationalizationMessage.from_dict(obj["name"]) if obj.get("name") is not None else None}
        )
        return _obj
