...
class Task(BaseModel):
    ...
    started_datetime: str | None = Field(default=None, description="現在のフェーズが開始された日時")
    updated_datetime: str = Field(description="更新日時")
    operation_updated_datetime: str | None = Field(default=None, description="タスクのステータスやフェーズ、担当者などが更新されたときの日時")
    sampling: StrictStr | None = Field(
        default=None,
