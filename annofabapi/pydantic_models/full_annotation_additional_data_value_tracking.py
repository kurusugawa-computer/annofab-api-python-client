...
class FullAnnotationAdditionalDataValueTracking(BaseModel):
    """
    FullAnnotationAdditionalDataValueTracking
    """

    type: StrictStr = Field(description="Tracking", alias="_type")
    value: Optional[StrictStr] = Field(default=None, description="トラッキングID")
