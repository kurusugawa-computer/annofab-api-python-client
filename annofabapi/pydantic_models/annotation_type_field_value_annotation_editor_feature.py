...
class AnnotationTypeFieldValueAnnotationEditorFeature(BaseModel):
    """
    作図ツール・作図モード
    """
    ...
    __properties: ClassVar[List[str]] = ["_type", "append", "erase", "freehand", "rectangle_fill", "polygon_fill", "fill_near"]

    @field_validator("type")
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["AnnotationEditorFeature"]):
            raise ValueError("must be one of enum values ('AnnotationEditorFeature')")
        return value
