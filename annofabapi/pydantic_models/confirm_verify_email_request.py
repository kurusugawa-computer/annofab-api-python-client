...
class ConfirmVerifyEmailRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["token", "confirmation_code"]
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"token": Token.from_dict(obj["token"]) if obj.get("token") is not None else None, "confirmation_code": obj.get("confirmation_code")}
        )
        return _obj
