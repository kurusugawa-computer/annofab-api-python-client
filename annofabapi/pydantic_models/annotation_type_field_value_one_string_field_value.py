...
class AnnotationTypeFieldValueOneStringFieldValue(BaseModel):
    """
    文字列を一つだけ持つフィールド
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["OneStringFieldValue"]):
            raise ValueError("must be one of enum values ('OneStringFieldValue')")
        return value
