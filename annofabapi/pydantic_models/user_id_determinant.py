...
class UserIdDeterminant(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_type", "user_id"]

    @field_validator("type")
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["UserId"]):
            raise ValueError("must be one of enum values ('UserId')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"_type": obj.get("_type"), "user_id": obj.get("user_id")})
        return _obj
