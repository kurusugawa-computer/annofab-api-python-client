...
class RevokeProjectTokenRequest(BaseModel):
    """
    RevokeProjectTokenRequest
    """

    project_id: StrictStr = Field(description="無効化するトークンが所属しているプロジェクトのID")
    project_token: StrictStr = Field(description="[issueProjectToken](#operation/issueProjectToken)で発行されたトークン文字列")
    __properties: ClassVar[List[str]] = ["project_id", "project_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"project_id": obj.get("project_id"), "project_token": obj.get("project_token")})
        return _obj
