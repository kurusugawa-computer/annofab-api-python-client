...
class AnnotationTypeFieldValueOneBooleanFieldValue(BaseModel):
    """
    真偽値をひとつだけ持つフィールド
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["OneBooleanFieldValue"]):
            raise ValueError("must be one of enum values ('OneBooleanFieldValue')")
        return value
