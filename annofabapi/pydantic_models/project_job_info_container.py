...
class ProjectJobInfoContainer(BaseModel):
    """
    ProjectJobInfoContainer
    """

    list: List[ProjectJobInfo] = Field(description="バックグラウンドジョブの一覧。作成日時の降順でソートされています。")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "list": [ProjectJobInfo.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None,
