...
class DataPath(BaseModel):
    ...
    path: StrictStr = Field(
        description="[putInputData](#operation/putInputData) APIや[putSupplementaryData](#operation/putSupplementaryData) APIのリクエストボディに指定するパスです。 "
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"url": obj.get("url"), "path": obj.get("path")})
        return _obj
