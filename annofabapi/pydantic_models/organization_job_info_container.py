...
from annofabapi.pydantic_models.organization_job_info import OrganizationJobInfo


class OrganizationJobInfoContainer(BaseModel):
    """
    OrganizationJobInfoContainer
    """

    list: List[OrganizationJobInfo] = Field(description="バックグラウンドジョブの一覧。作成日時の降順でソートされています。")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "list": [OrganizationJobInfo.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None,
