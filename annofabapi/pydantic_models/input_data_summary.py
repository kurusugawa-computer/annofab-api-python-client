...
class InputDataSummary(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in annotation_summaries (list)
        _items = []
        ...
        _obj = cls.model_validate(
            {
                ...
                "inspection_summary": obj.get("inspection_summary"),
                "annotation_summaries": [ValidationError.from_dict(_item) for _item in obj["annotation_summaries"]]
                if obj.get("annotation_summaries") is not None
                else None,
            }
        )
        return _obj
