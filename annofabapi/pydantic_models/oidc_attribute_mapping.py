...
class OidcAttributeMapping(BaseModel):
    """
    外部IDプロバイダー上の属性と、Annofabが認識する属性のマッピング
    """

    email: StrictStr = Field(description="Eメールアドレスを表す外部IDプロバイダー上の属性名")
    name: StrictStr = Field(description="ユーザーの表示名を表す外部IDプロバイダー上の属性名")
