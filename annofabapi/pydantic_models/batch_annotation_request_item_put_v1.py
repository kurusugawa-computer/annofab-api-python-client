...
from annofabapi.pydantic_models.batch_annotation_v1 import BatchAnnotationV1


class BatchAnnotationRequestItemPutV1(BaseModel):
    """
    アノテーション更新
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"data": BatchAnnotationV1.from_dict(obj["data"]) if obj.get("data") is not None else None, "_type": obj.get("_type")}
        )
        return _obj
