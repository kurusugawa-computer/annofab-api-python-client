...
class ProjectAccountStatistics(BaseModel):
    """
        ...
        _obj = cls.model_validate(
            {
                ...
                "histories": [ProjectAccountStatisticsHistory.from_dict(_item) for _item in obj["histories"]]
                if obj.get("histories") is not None
                else None,
            }
        )
        return _obj
