...
class ProjectList(BaseModel):
    ...
    list: List[Project] = Field(description="現在のページ番号に含まれる0件以上のプロジェクトです。")
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "list": [Project.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None,
