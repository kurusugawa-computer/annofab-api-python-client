...
class SupplementaryDataByInputDataIdIdentifier(BaseModel):
    """
    補助情報の所属先
    """
    ...
    __properties: ClassVar[List[str]] = ["project_id", "input_data_id"]
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"project_id": obj.get("project_id"), "input_data_id": obj.get("input_data_id")})
        return _obj
