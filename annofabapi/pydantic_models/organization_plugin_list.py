...
from annofabapi.pydantic_models.organization_plugin import OrganizationPlugin


class OrganizationPluginList(BaseModel):
    """
    OrganizationPluginList
    """

    list: List[OrganizationPlugin] = Field(description="プラグイン一覧")
    ...
    aggregations: List[Dict[str, Any]] = Field(description="システム内部用のプロパティ。 ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "list": [OrganizationPlugin.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None,
