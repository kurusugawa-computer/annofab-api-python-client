...
class AnnotationDetailContentInputOuter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_type", "path"]
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"_type": obj.get("_type"), "path": obj.get("path")})
        return _obj
