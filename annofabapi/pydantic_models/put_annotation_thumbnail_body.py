...
from annofabapi.pydantic_models.annotation_thumbnail_image_source import AnnotationThumbnailImageSource


class PutAnnotationThumbnailBody(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "images": [AnnotationThumbnailImageSource.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None,
