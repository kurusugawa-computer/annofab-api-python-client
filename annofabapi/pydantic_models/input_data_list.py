...
class InputDataList(BaseModel):
    ...
    list: List[InputData] = Field(description="現在のページ番号に含まれる0件以上の入力データです。")
    ...
    over_limit: StrictBool = Field(description="検索結果の件数が1万件を超えた場合は`true`になります。")
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "list": [InputData.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None,
