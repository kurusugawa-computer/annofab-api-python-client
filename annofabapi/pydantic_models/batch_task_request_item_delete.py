...
class BatchTaskRequestItemDelete(BaseModel):
    """
    タスク削除
    """
    ...
    __properties: ClassVar[List[str]] = ["project_id", "task_id", "_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"project_id": obj.get("project_id"), "task_id": obj.get("task_id"), "_type": obj.get("_type")})
        return _obj
