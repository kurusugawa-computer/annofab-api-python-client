...
class PluginTokenResponse(BaseModel):
    ...
    access_token: StrictStr = Field(
        description="APIアクセスに用いるトークン。 リクエストヘッダにおいて `Authorization: Bearer {access_token}` の形で指定します。 "
    )
    refresh_token: StrictStr = Field(description="トークンの更新に用いるトークン")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"access_token": obj.get("access_token"), "refresh_token": obj.get("refresh_token")})
        return _obj
