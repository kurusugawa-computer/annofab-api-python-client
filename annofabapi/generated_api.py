...
class AbstractAnnofabApi(abc.ABC):
    ...
    def get_project_extra_data(
        self, project_id: str, kind_id: str, query_params: Optional[dict[str, Any]] = None, **kwargs
    ) -> tuple[Any, requests.Response]:
        """プロジェクトの追加データ取得
    ...
    def put_project_extra_data(
        self, project_id: str, kind_id: str, query_params: Optional[dict[str, Any]] = None, request_body: Optional[Any] = None, **kwargs
    ) -> tuple[Any, requests.Response]:
        """プロジェクトの追加データ更新
