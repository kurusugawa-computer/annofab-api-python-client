...
class AbstractAnnofabApi(abc.ABC):
    ...
    def post_annotation_archive_update(self, project_id: str, query_params: Optional[Dict[str, Any]] = None,
                                       **kwargs) -> Tuple[Any, requests.Response]:
        """アノテーションZIP更新開始
    ...
    def delete_project(self, project_id: str, query_params: Optional[Dict[str, Any]] = None,
                       **kwargs) -> Tuple[Any, requests.Response]:
        """プロジェクト削除
    ...
    def initiate_project_copy(self, project_id: str, query_params: Optional[Dict[str, Any]] = None,
                              request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """プロジェクト複製
    ...
    def initiate_tasks_generation(self, project_id: str, query_params: Optional[Dict[str, Any]] = None,
                                  request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """タスク一括作成
