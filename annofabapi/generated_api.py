...
class AbstractAnnofabApi(abc.ABC):
    ...
    def change_password(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """パスワード変更
    ...
    def confirm_reset_email(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """メールアドレスstep2（確定）
    ...
    def confirm_reset_password(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
    ...
    def confirm_signup(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """サインアップstep2（確定）
    ...
    def confirm_verify_email(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """メールアドレス検証step2（確定）
    ...
    def initiate_password_reset(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """パスワードリセットstep1（開始）
    ...
    def initiate_reset_email(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """メールアドレスリセットstep1（開始）
    ...
    def initiate_signup(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """サインアップstep1（開始）
    ...
    def initiate_verify_email(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """メールアドレス検証step1（開始）
    ...
    def reset_password(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
    ...
    def get_annotation_specs_histories(
            self,
            project_id: str,
    ) -> Tuple[Any, requests.Response]:
        """アノテーション仕様履歴取得
    ...
    def batch_update_inputs(self, project_id: str, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """入力データ一括更新
    ...
    def put_instruction(self, project_id: str, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """作業ガイドの更新
    ...
    def confirm_my_account_delete(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """アカウント削除step2（確定）
    ...
    def get_my_account(self, ) -> Tuple[Any, requests.Response]:
        """自分のアカウント取得
    ...
    def get_my_project_members(self, ) -> Tuple[Any, requests.Response]:
        """自分のプロジェクトメンバー情報一括取得
    ...
    def initiate_my_account_delete(self, ) -> Tuple[Any, requests.Response]:
        """アカウント削除step1
    ...
    def put_my_account(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """自分のアカウント情報更新
    ...
    def update_organization(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """組織名変更
    ...
    def create_new_organization(self, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """組織新規作成
    ...
    def accept_organization_invitation(self, organization_name: str, user_id: str,
                                       request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """組織への招待受諾
    ...
    def update_organization_member_role(self, organization_name: str, user_id: str,
                                        request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """組織メンバーのロール更新
    ...
    def batch_update_tasks(self, project_id: str, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """タスク一括更新
    ...
    def start_task(self, project_id: str, request_body: Optional[Any] = None) -> Tuple[Any, requests.Response]:
        """タスク割当
