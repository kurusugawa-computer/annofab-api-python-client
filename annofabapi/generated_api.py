...
class AbstractAnnofabApi(abc.ABC):
    ...
    def batch_update_annotations(self, project_id: str, request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """アノテーション一括更新
    ...
    def get_editor_annotation(self, project_id: str, task_id: str, input_data_id: str, query_params: Optional[Dict[str, Any]] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """アノテーションの取得
    ...
    def put_annotation(self, project_id: str, task_id: str, input_data_id: str, request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """アノテーション更新
    ...
    def put_annotation_specs(self, project_id: str, request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """アノテーション仕様更新
    ...
    def batch_update_comments(self, project_id: str, task_id: str, input_data_id: str, query_params: Optional[Dict[str, Any]] = None, request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """コメント一括更新
    ...
    def get_comments(self, project_id: str, task_id: str, input_data_id: str, query_params: Optional[Dict[str, Any]] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """コメント一括取得
    ...
    def batch_update_inspections(self, project_id: str, task_id: str, input_data_id: str, request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """検査コメント一括更新
    ...
    def update_organization(self, request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        ...
        """
        warnings.warn("annofabapi.AnnofabApi.update_organization() is deprecated and will be removed.", FutureWarning, stacklevel=2)
        url_path = f'/my/organizations'
        http_method = 'PUT'
        keyword_params: Dict[str, Any] = {
            'request_body': request_body,
    ...
    def get_projects_of_organization(self, organization_name: str, query_params: Optional[Dict[str, Any]] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """組織配下プロジェクトの一括取得
    ...
    def delete_organization_input_data(self, organization_name: str, input_data_set_id: str, input_data_id: str, **kwargs) -> Tuple[Any, requests.Response]:
        """入力データセット内の入力データの削除
    ...
    def get_organization_input_data(self, organization_name: str, input_data_set_id: str, input_data_id: str, **kwargs) -> Tuple[Any, requests.Response]:
        """入力データセット内の入力データの取得
    ...
    def get_organization_input_data_list(self, organization_name: str, input_data_set_id: str, query_params: Optional[Dict[str, Any]] = None, **kwargs) -> Tuple[Any, requests.Response]:
    ...
    def put_input_data_set(self, organization_name: str, input_data_set_id: str, request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """入力データセットの作成/更新
    ...
    def accept_organization_invitation(self, organization_name: str, user_id: str, request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """組織への招待の受諾
    ...
    def invite_organization_member(self, organization_name: str, user_id: str, request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """ユーザーを組織に招待
    ...
    def update_organization_member_role(self, organization_name: str, user_id: str, request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """組織メンバーのロール更新
    ...
    def put_organization_plugin(self, organization_name: str, plugin_id: str, request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """プラグインの作成/更新
    ...
    def put_project(self, project_id: str, query_params: Optional[Dict[str, Any]] = None, request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """プロジェクト作成/更新
    ...
    def get_inspection_daily_statistics(self, project_id: str, query_params: Optional[Dict[str, Any]] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """ラベル別検査コメント数の取得
    ...
    def get_worktime_daily_statistics(self, project_id: str, query_params: Optional[Dict[str, Any]] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """単位あたり作業時間の取得
    ...
    def get_worktime_daily_statistics_by_account(self, project_id: str, account_id: str, query_params: Optional[Dict[str, Any]] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """メンバーの単位あたり作業時間の取得
    ...
    def put_supplementary_data(self, project_id: str, input_data_id: str, supplementary_data_id: str, request_body: Optional[Any] = None, **kwargs) -> Tuple[Any, requests.Response]:
        """補助情報作成/更新
